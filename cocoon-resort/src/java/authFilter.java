...
//        System.out.print("authFilter");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String destination = url.split("/")[4];

        if (destination.equals("ReservationServlet")) {//
            isAuth = false;
            ...
            try {
                ...
                if (headerNames != null) {
                    ...
                    if (queryString.equals("readByCustomer")) {
                        ...
                        if (jwtClass.parseJWT(jwt, queryId)) {
                            System.out.print("in the 2nd if");
                            isAuth = true;
                        }
                    } else {
                        if (jwtClass.parseJWT(jwt, "")) {
                            isAuth = true;
                        }
                    }
                }
